...
class Actor extends _entity_js__WEBPACK_IMPORTED_MODULE_4__["default"] {
	...
	moveItemToSlot(slot, newSlot) {
		...
		function swapSlots() {
			...
			_util_js__WEBPACK_IMPORTED_MODULE_3__["default"].swap(self.inventory, slot, newSlot);
			self.calcBonusStats();
		}
